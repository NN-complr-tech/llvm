...
#define DEBUG_TYPE "x86-shekhirev-unroll"

using namespace llvm;

namespace {

class ShekhirevLoopUnroller : public MachineFunctionPass {
public:
  static char ID;

  const unsigned UnrollFactor = 2;

  ShekhirevLoopUnroller() : MachineFunctionPass(ID) {}
...
char ShekhirevLoopUnroller::ID = 0;

} // namespace

static RegisterPass<ShekhirevLoopUnroller>
    X("x86-shekhirev-unroll", "Shekhirev Machine Loop Unroller", false, false);